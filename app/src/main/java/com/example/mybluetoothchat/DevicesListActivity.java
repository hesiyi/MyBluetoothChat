...
public class DevicesListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        filter = new IntentFilter(bluetoothDevice.Action_Bluetooth_Discovery_Finish);
        this.registerReceiver(mReceiver, filter);

        // Get a set of currently paired devices
        Set<android.bluetooth.BluetoothDevice> pairedDevices = bluetoothDevice.getPairedDevices();
    ...
    protected void onDestroy() {
        ...
        if (bluetoothDevice.getBluetoothAdapter() != null) {
            bluetoothDevice.discoveryBluetooth_Cancel();
        }
    ...
    private void doDiscovery() {
        ...
        if (bluetoothDevice.isBluetooth_discovering()) {
            bluetoothDevice.discoveryBluetooth_Cancel();
        }

        // Request discover from BluetoothAdapter
        bluetoothDevice.discoveryBluetooth_Start();
    }
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            } else if (bluetoothDevice.Action_Bluetooth_Discovery_Finish.equals(action)) {
